...
#This is the directory under which both java and python programs will write their files.
path_to_java_shared_directory = os.path.abspath(os.path.join(os.getcwd(), "..", "..", "..", "producedfiles"))
...
wordvectorsfile = os.path.join(path_to_java_shared_directory, 'models', word_vectors_filename)
